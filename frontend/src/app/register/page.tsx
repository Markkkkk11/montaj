                    ...
                    <div className="overflow-y-auto flex-1 px-6 py-5 space-y-5">
                      ...
                      <section>
                        ...
                        <div className="text-sm text-gray-600 leading-relaxed space-y-2 pl-9">
                          ...
                          <p>В заявке указать точные данные заявителя (ФИО — должны соответствовать данным, как в личном кабинете пользователя), контактный номер телефона, реквизиты карты банка, серия и номер паспорта, дата выдачи, кем выдан, сумма.</p>
